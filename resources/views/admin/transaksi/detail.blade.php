                   ...
                   <div class="col-md-7">
                    <table>
                        ...
                        <tr>
                            <td>Total</td>
                            <td>:</td>
                            <td  class="p-2">Rp{{ number_format($transactions->sub_total, 2, ',', '.') }}</td>
                        </tr>
                        @if($transactions->bukti_pembayaran != null)
                            ...
                            @if($transactions->status_id == 1)
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td  class="p-2"><a href="{{ route('transaksi.konfirmasi',$transactions->id) }}" onclick="return confirm('Yakin ingin mengonfirmasi pesanan ini?')" class="btn btn-primary mt-1">Konfirmasi Telah Bayar</a><br>
