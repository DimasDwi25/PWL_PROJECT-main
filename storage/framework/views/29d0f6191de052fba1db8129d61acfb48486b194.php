...
unset($__errorArgs, $__bag); ?>"
                            id="date" name="date" value="<?php echo e($jadwals); ?>" />
                    </div>
                </div> 
                <div class="modal-body">
                    <div class="form-group mb-2">
...
</div><?php /**PATH D:\Project Laravel\PWL_PROJECT-main\resources\views/customer/lapangan/modal/addModal.blade.php ENDPATH**/ ?>