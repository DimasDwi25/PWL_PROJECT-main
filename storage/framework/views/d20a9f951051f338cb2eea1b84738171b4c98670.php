        ...
        <div class="container">
            ...
            <div class="daftar-lapangan">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-4 mt-5" data-aos="fade-up">
                            <div class="block-4 text-center border">
                                ...
                                <div class="block-4-text p-4">
                                    ...
                                    <p class="mb-0" style="color: black">Rp.<?php echo e(number_format($arena->price, 2, ',', '.')); ?>/ Jam</p>
                ...
                <div class="deskripsi">
                    ...
                    <p style="color: black">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptates neque error molestias aliquam esse facilis inventore sunt ab aspernatur porro vero, doloribus ut natus asperiores minima! Voluptate assumenda libero quas!</p>
                </div>
...
<?php echo $__env->make('customer.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Laravel\PWL_PROJECT-main\resources\views/customer/daftar-lap/detailLapangan.blade.php ENDPATH**/ ?>